...
const ChatGPTCoursePageWrapper = () => {
  ...
  const ClubsPageWrapper = () => {
    const navigate = useNavigate();
    return (
      <Suspense fallback={<LoadingSpinner />}>
        <ClubsPage onBack={() => navigate('/')} />
      </Suspense>
    );
  };
  ...
  const AIConstructionSitePageWrapper = () => {
    const navigate = useNavigate();
    return (
      <Suspense fallback={<LoadingSpinner />}>
        <AIConstructionSitePage onBack={() => navigate('/')} />
      </Suspense>
    );
  };
  ...
  const AIConstructionSiteStep2PageWrapper = () => {
    return (
      <Suspense fallback={<LoadingSpinner />}>
        <AIConstructionSiteStep2Page />
      </Suspense>
    );
  };

  const AIConstructionSiteStep3PageWrapper = () => {
    return (
      <Suspense fallback={<LoadingSpinner />}>
        <AIConstructionSiteStep3Page />
      </Suspense>
    );
  };
