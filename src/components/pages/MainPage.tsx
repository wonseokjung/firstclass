...
const premiumClasses: Course[] = [
  ...
  { id: 999, instructor: '정원석 (AI 멘토 제이)', title: 'Step 1: AI 건물주 되기', subtitle: '✨ "무엇을 만들어야 팔리는지" + 압도적인 비주얼', description: '그냥 AI 이미지 생성이 아닙니다. 처음부터 수익화를 설계하고, 압도적인 비주얼로 차별화하세요!', image: `${process.env.PUBLIC_URL}/images/메인화면/1.jpeg`, isNew: true, category: 'Premium', path: '/ai-building-course', isPremium: true, launchDate: '🔥 얼리버드 진행 중', price: 45000, originalPrice: 95000, isComingSoon: false },
  ...
  { id: 1003, instructor: '정원석 (AI 멘토 제이)', title: 'Step 3: AI 에이전트 파견소', subtitle: '🤖 교육 + 도구: AI 직원을 파견받아 실전!', description: '🚀 AI 에이전트를 파견받아 콘텐츠 사업을 시작하세요! 대본→이미지→음성→영상 자동화', image: `${process.env.PUBLIC_URL}/images/메인화면/3.jpeg`, isNew: true, category: 'Premium', path: '#', isPremium: true, launchDate: '준비중', price: 0, originalPrice: 0, isComingSoon: true },
