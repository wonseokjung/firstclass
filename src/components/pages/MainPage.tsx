...
const premiumClasses: Course[] = [
  ...
  { id: 1002, instructor: '정원석 (AI 멘토 제이)', title: 'ChatGPT AI AGENT 비기너편', subtitle: '🤖 나만의 AI 에이전트 만들기', description: '💡 ChatGPT를 활용해 업무를 자동화하는 AI 에이전트를 직접 만들어보세요! 18강의로 완성하는 실전 AI 에이전트 개발 과정', image: `${process.env.PUBLIC_URL}/images/ChatGPT에이전트.png`, isNew: true, category: 'Premium', path: '/chatgpt-agent-beginner', isPremium: true, launchDate: '2025-11-15', price: 45000, originalPrice: 95000, isComingSoon: false }
