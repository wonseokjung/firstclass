...
const premiumClasses: Course[] = [
  ...
  // Step 2: AI 에이전트 비기너 - 나만의 에이전트 팀 구축
  { id: 1002, instructor: '정원석 (AI 멘토 제이)', title: 'Step 2: AI 에이전트 비기너', subtitle: '나만의 에이전트 팀', description: 'AI 에이전트들이 협업하는 나만의 팀을 구축! 기획·영상·음성·편집 에이전트가 자동으로 콘텐츠를 만들어냅니다.', image: `${process.env.PUBLIC_URL}/images/main/2.jpeg`, isNew: true, category: 'Premium', path: '/chatgpt-agent-beginner', isPremium: true, launchDate: '지금 수강 가능', price: 95000, originalPrice: 95000, isComingSoon: false },
