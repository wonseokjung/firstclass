      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <input
                  type="text"
                  readOnly
                  value="https://opal.google/?flow=drive:/12PL3LnSVefKDdSfRRy5oRNyAGk0f5py2&shared&mode=app"
                  style={{
                    flex: 1,
                ...
                <button
                  onClick={() => {
                    navigator.clipboard.writeText('https://opal.google/?flow=drive:/12PL3LnSVefKDdSfRRy5oRNyAGk0f5py2&shared&mode=app');
            ...
            <a
              href="https://opal.google/?flow=drive:/12PL3LnSVefKDdSfRRy5oRNyAGk0f5py2&shared&mode=app"
              target="_blank"
