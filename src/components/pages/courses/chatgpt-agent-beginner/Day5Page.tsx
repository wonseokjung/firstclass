            ...
            <div style={{
              ...
              <div style={{
                ...
                <input
                  type="text"
                  readOnly
                  value="https://opal.google/?flow=drive:/17JvxIVkjx6tDzzTPPfwrNtURuEsSMTpM&shared&mode=app"
                  style={{
                    flex: 1,
                ...
                <button
                  onClick={() => {
                    navigator.clipboard.writeText('https://opal.google/?flow=drive:/17JvxIVkjx6tDzzTPPfwrNtURuEsSMTpM&shared&mode=app');
