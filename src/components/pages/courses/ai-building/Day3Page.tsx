...
import { ArrowLeft, CheckCircle, PlayCircle, BookOpen, ExternalLink, Lightbulb, Globe, Video, Target, MessageCircle, Heart, Send, User, Calculator, DollarSign } from 'lucide-react';
