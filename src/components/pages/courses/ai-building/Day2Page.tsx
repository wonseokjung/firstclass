...
import { ArrowLeft, CheckCircle, PlayCircle, Clock, BookOpen, ExternalLink, Lightbulb, Building2, Video, Rocket, Target, MessageCircle, Heart, Send, User } from 'lucide-react';
