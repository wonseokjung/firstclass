...
import { ArrowLeft, CheckCircle, PlayCircle, BookOpen, ExternalLink, Lightbulb, Target, MessageCircle, Heart, Send, User, Sparkles, Palette, Code, Key, Zap } from 'lucide-react';
