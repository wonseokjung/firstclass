  ...
  useEffect(() => {
    ...
    if (userSession) {
      try {
        ...
        // AI 건물주 되기 (Step 1) 수강 여부 확인
        const hasStep1 = enrollments.some((e: any) => 
          e.courseId === 'ai-building-course' || e.courseId === 'ai-building'
        );
        setIsEnrolled(hasStep1);
      } catch (e) {
      ...
      <div style={{ maxWidth: '900px', margin: '0 auto', padding: 'clamp(20px, 4vw, 40px) clamp(15px, 3vw, 20px)' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '50px' }}>
          <div style={{ 
            ...
            <span style={{ color: 'white', fontWeight: '700' }}>STEP 1</span>
          </div>
          <h1 style={{ 
            color: 'white', 
            fontSize: '2.5rem', 
        ...
        <div style={{
          ...
          <h3 style={{ color: '#22c55e', marginBottom: '15px', fontSize: '1.2rem' }}>
            💬 커뮤니티에서 소통하세요
          </h3>
          ...
          <button
            onClick={() => window.location.href = '/community/step1'}
            style={{
              background: '#22c55e',
              color: 'white',
              border: 'none',
